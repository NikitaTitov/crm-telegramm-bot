...
public class ButtonsHandler {
	...
	public final static InlineKeyboardButton AUTH_BUTTON = new InlineKeyboardButton().setText("Аутентификация").setCallbackData("/auth");
	...
	public final static InlineKeyboardButton FOOD_MENU_BUTTON = new InlineKeyboardButton().setText("Добавить заказ").setCallbackData("/menu");
	public final static InlineKeyboardButton TO_ALL_CLIENTS_BUTTON = new InlineKeyboardButton().setText("Добавить заказ всем");
}
